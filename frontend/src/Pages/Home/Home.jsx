        ...
        <>
            <div className={!sideBarToggle ? `home-wrapper` : "home_wrapper_full"}>
                <div className=" bg-dark-black">
                    <SideBarTab toggleProp={setSideBarToggle} sideBarOption={sideBarOptions} />
                </div>
                <div className={sideBarToggle ? `bg-home-white-smoke relative w-full rounded-r-[15px]` : "bg-home-white-smoke relative w-full rounded-[15px]"}  >
                    <div className='pt-[50px] home_inner_page'>
                        ...
                        <div className='fixed right-[30px] bottom-[45px] ai_writer '>
                        ...
                        </div>
                        {
                            aiToggle && (
                                <>
                                    <div className='ask_ai fixed right-[90px] bottom-[18px] z-10'>
                        ...
                        <div className='add_new_page_button text-center py-[18px] relative w-[400px] m-auto '>
                            <button className='w-[400px] m-auto flex gap-5 justify-center  border border-[#E7E8E9] bg-white py-2 text-grey-color text-[11px] rounded-[10px]'>Add new page <span>+</span></button>
                    ...
                    <div className={aiToggle ? "hidden" : 'mobile_view_bottom_buttons absolute bottom-0 w-[100%] block md:hidden'}>
                        <nav className='flex justify-between p-[15px]'>
