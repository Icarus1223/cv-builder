      ...
      <div class="flex flex-col items-center justify-center px-[15px] pb-8 md:pt-[70px] pt-[30px] md:mx-auto  bg-dark-black">
        <div class=" rounded-xl w-[100%] sm:w-[400px] h-[630px] border border-light-grey">
          <div class=" pt-[100px] px-[25px] sm:px-[30px]  ">
            ...
            <a href={`${process.env.BASE_URL}/linkedin`} className='signup_with_social_acc mt-[40px] shadow drop-shadow-3xl flex bg-white py-[16px] rounded-[15px] items-center justify-center gap-[16px]'>
              <Linkdin />
              <Typography className="text-[20px] font-medium text-LoginPage-color">Sign up with LinkedIn</Typography>
            </a>
            <a href={`${process.env.BASE_URL}/google`} className='signup_with_social_acc mt-[40px] shadow drop-shadow-3xl flex bg-white py-[16px] rounded-[15px] items-center justify-center gap-[16px]'>
              <GoggleIcon />
              <Typography className="text-[20px] font-medium text-LoginPage-color">Sign up with Google</Typography>
            </a>
            <a href={`${process.env.BASE_URL}/twitter`} className='signup_with_social_acc mt-[40px] shadow drop-shadow-3xl flex bg-white py-[16px] rounded-[15px] items-center justify-center gap-[16px]'>
              <TwitterIcon />
